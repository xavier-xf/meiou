...
#define TUYA_IPC_STREAM_BASE_PATH "/mnt/tuya/"
...
/**
 * \fn OPERATE_RET tuya_ipc_ss_init(IN CHAR_T *base_path, IN IPC_MEDIA_INFO_S *media_setting, IN UINT_T max_event_per_day, AES_HW_CBC_FUNC * aes_func)
 ...
 * \param[in] max_event_per_day: max event number per day, this limitation should be based on Soc ability, 
 ...
 * \return OPERATE_RET
 */
OPERATE_RET tuya_ipc_ss_init(IN CHAR_T *base_path, IN IPC_MEDIA_INFO_S *media_setting, IN UINT_T max_event_per_day, AES_HW_CBC_FUNC * aes_func);
...
/**
 * \fn OPERATE_RET tuya_ipc_ss_download_set_status(IN UINT_T pb_idx, IN SS_DOWNLOAD_STATUS_E new_status)
