...
/*====================
   Graphical settings/
 *====================*/
#define ROM_BIN_PATH	    "/app/app/rom.bin"//"/mnt/res/rom.bin"// "/etc/config/res/rom.bin"
#define TTF_FILE_PATH		 "/app/app/sat_leo.ttf"//"/mnt/res/sat_leo.ttf" //"/etc/config/sat_leo.ttf"
...
#define LV_COLOR_SCREEN_TRANSP    0 //0
...
#define LV_DISP_DEF_REFR_PERIOD     33//33// 30      /*[ms]*/
 ...
 */
#define LV_USE_EXT_CLICK_AREA  LV_EXT_CLICK_AREA_FULL //LV_EXT_CLICK_AREA_TINY
...
#define LV_USE_LED      1
#if LV_USE_LED
#  define LV_LED_BRIGHT_MIN  50//120      /*Minimal brightness*/
