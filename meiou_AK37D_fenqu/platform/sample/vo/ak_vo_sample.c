...
{
    printf("\nexample: \r\n"
            "\t%s -w 1024 -e 600  -x 0  -r 1920 -s 1080 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n"
            "\t%s -w 1280 -e 800  -x 90 -r 1920 -s 1080 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n"
            "\t%s -w 1920 -e 1200 -x 90 -r 1920 -s 1080 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n" ,
            name, name, name );
    printf("\tNOTE:the logo-dir should name anyka.logo.577.160.rgb, this file format is rgb888\n");
}
