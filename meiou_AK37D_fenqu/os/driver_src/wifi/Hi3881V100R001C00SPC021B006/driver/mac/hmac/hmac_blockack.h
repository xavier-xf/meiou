 ...
 * Description: Header file for dmac_blockack.c
 * Author: Hisilicon
 * Create: 2018-08-04
 */
...
#define HMAC_BA_RX_VI_TIMEOUT      60 /* 60 milliseconds */
#define HMAC_BA_RX_BE_TIMEOUT      40 /* 40 milliseconds */
#define HMAC_BA_RX_BK_TIMEOUT      60 /* 60 milliseconds */
...
#define hmac_tx_buf_bitmap_clr(_bitmap, _idx)            \
    (_bitmap[_idx >> HMAC_TX_BUF_BITMAP_LOG2_WORD_SIZE] &= \
   ~((hi_u32)(1 << (_idx & HMAC_TX_BUF_BITMAP_WORD_MASK))))
...
/*****************************************************************************
  3 函数声明
*****************************************************************************/
hi_u32  hmac_ba_filter_serv(const mac_vap_stru *mac_vap,
                            const hmac_user_stru *hmac_user,
                            const hmac_rx_ctl_stru *cb_ctrl,
...
hi_u8 hmac_mgmt_check_set_rx_ba_ok(const hmac_vap_stru *hmac_vap,
                                   hmac_ba_rx_stru *ba_rx_info, hmac_device_stru *hmac_dev);
