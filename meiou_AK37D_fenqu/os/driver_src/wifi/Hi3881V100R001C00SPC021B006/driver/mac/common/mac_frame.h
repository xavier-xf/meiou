...
#define MAC_WLAN_OUI_HUAWEI0                0x00        /* HUAWEI OUI 定义 0x00E0FC */
...
static inline hi_void mac_get_submsdu_len(const hi_u8 *puc_submsdu_hdr, hi_u16 *pus_submsdu_len)
{
    ...
    *pus_submsdu_len = (hi_u16)((*pus_submsdu_len << 8) + /* 左移8bit，获取submsdu_len */
...
static inline hi_u8 mac_is_hide_ssid(hi_u8 *puc_ssid_ie, hi_u8 uc_ssid_len)
{
    return ((puc_ssid_ie == HI_NULL) || (uc_ssid_len == 0) || (puc_ssid_ie[0] == '\0'));
}
