...
#ifdef _PRE_LOSCFG_KERNEL_SMP
#ifndef G_HI_SMP_SPIN_LOCK
#define G_HI_SMP_SPIN_LOCK
static SPIN_LOCK_INIT(g_hi_smp_spinlock);
#endif
#endif
...
static inline hi_s32 hi_atomic_add_return(hi_s32 i, hi_atomic *v)
{
...
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinLockSave(&g_hi_smp_spinlock, &irq_status);
#else
    ...
    val = v->counter;
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinUnlockRestore(&g_hi_smp_spinlock, irq_status);
#else
