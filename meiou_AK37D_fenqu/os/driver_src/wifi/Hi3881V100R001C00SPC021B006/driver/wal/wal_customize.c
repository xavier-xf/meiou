...
{
    g_customize_init_params[INIT_CFG_RF_RX_INSERTION_LOSS_2G_B1]             =
        data->init_cfg_rf_rx_insertion_loss_2g_b1;
    g_customize_init_params[INIT_CFG_RF_RX_INSERTION_LOSS_2G_B2]             =
        data->init_cfg_rf_rx_insertion_loss_2g_b2;
    g_customize_init_params[INIT_CFG_RF_RX_INSERTION_LOSS_2G_B3]             =
        data->init_cfg_rf_rx_insertion_loss_2g_b3;
...
static hi_u32 init_nvm_param(hi_void)
{
    ...
    if (ret != HI_SUCCESS) {
        ...
        wal_cfg_params temp = {
            92, 64, 25, 15, 10, 64, 8, 1, 1, 2, 0x9c9c9c9c, 0x666C6C6C, 0x666C6C6C,
            0x57575757, 0x5c5c5757, 0x5a5a5a5a, 0x5d5d5a5a, 0x414F, 0x424b, 32768,
            0, -1, -1, -1, 115, 115, 115, 500, 17, 650, 13, 280, 5, 7, 0, 1, 1, 140, 140, 140, 0x68, 0x62, 0x62, 1, 0
        };
    ...
    if (ret != HI_SUCCESS) {
        ...
        wal_cfg_rf_reg1 temp = {
            0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
            0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
            0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
            0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208
        };
    ...
    if (ret != HI_SUCCESS) {
        ...
        wal_cfg_rf_reg2 temp = {0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
                                0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
                                0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
                                0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
                                0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208, 0x12081208,
                                0x12081208, 0x12081208};
...
static hi_u32 wal_customize_init_country(oal_net_device_stru* netdev)
{
    ...
    if (oal_unlikely(ret != HI_SUCCESS)) {
        oam_error_log1(0, OAM_SF_ANY,
            "{wal_customize_init_country::wal_send_cfg_event return err code [%u]!}\r\n", ret);
        return ret;
    }
...
static hi_u32 wal_customize_init_log(oal_net_device_stru* netdev)
{
    ...
    *((hi_u32*)(write_msg.auc_value)) = l_loglevel;
    ret = wal_send_cfg_event(netdev, WAL_MSG_TYPE_WRITE,
                             WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(hi_s32), (hi_u8*)&write_msg, HI_FALSE, HI_NULL);
    if (oal_unlikely(ret != HI_SUCCESS)) {
...
static hi_u32 wal_customize_init_clock(oal_net_device_stru* netdev)
{
    ...
    if (oal_unlikely(ret != HI_SUCCESS)) {
        oam_error_log1(0, OAM_SF_ANY,
            "{wal_customize_init_clock::wal_send_cfg_event return err code [%u]!}\r\n", ret);
        return ret;
    }
...
static hi_u32 wal_customize_init_rf(oal_net_device_stru* netdev)
{
    ...
    /* 配置: 2g rf */
    for (hi_u8 idx = 0; idx < MAC_NUM_2G_BAND; ++idx) {
    ...
    for (hi_u8 level = 0; level < 3; ++level) { /* 3 不超过3层 */
...
hi_u32 wal_customize_init_band_edge_limit(mac_cus_band_edge_limit_stru* band_edge_limit)
{
    ...
    hi_u8 error_param = HI_FALSE;      /* 参数有效性标志，任意参数值不合法则置为1，所有参数不下发 */
    /* 实际需要进行配置的FCC认证band数 */
    hi_u8 fcc_auth_band_num = 3;  /* 3 band数 */
    /* 赋值idx、txpwr */
...
static hi_u32 wal_customize_init_cali(oal_net_device_stru* netdev)
{
    wal_msg_write_stru      write_msg;
    hi_u32                  ret;
    mac_cus_dts_cali_stru   cus_cali;
    ...
    memset_s(&cus_cali, sizeof(mac_cus_dts_cali_stru), 0, sizeof(mac_cus_dts_cali_stru));
    if (wal_customize_init_dts_cali(&cus_cali) != HI_SUCCESS) {
        return HI_FAIL;
    }

    /* 如果所有参数都在有效范围内，则下发配置值 */
    if (memcpy_s(write_msg.auc_value, sizeof(mac_cus_dts_cali_stru),
        (hi_s8*)&cus_cali, sizeof(mac_cus_dts_cali_stru)) != EOK) {
    ...
    ret = wal_send_cfg_event(netdev,
                             WAL_MSG_TYPE_WRITE,
                             (hi_u16)(WAL_MSG_WRITE_MSG_HDR_LENGTH + offset),
                             (hi_u8*)&write_msg,
                             HI_FALSE,
                             HI_NULL);
    if (oal_unlikely(ret != HI_SUCCESS)) {
...
static hi_u32 wal_customize_init_dbb(oal_net_device_stru* netdev)
{
    ...
    if (memcpy_s(write_msg.auc_value, sizeof(dbb_scaling_stru),
        (hi_s8*)&dbb_scaling_params, sizeof(dbb_scaling_stru)) != EOK) {
        oam_error_log0(0, OAM_SF_ANY, "{wal_customize_init_dbb::mem safe function err!}");
        return HI_FAIL;
    }
...
static hi_u32 wal_customize_init_freq_comp(oal_net_device_stru* netdev)
{
    ...
    if (freq_comp_params.high_temp_th < FREQ_COMP_TEMP_MIN || freq_comp_params.high_temp_th > FREQ_COMP_TEMP_MAX) {
        oam_error_log3(0, OAM_SF_ANY,
            "{wal_customize_init_freq_comp::high_threshold[%d] out of range[%d,%d]!}\r\n",
    ...
    if (freq_comp_params.low_temp_th < FREQ_COMP_TEMP_MIN || freq_comp_params.low_temp_th > FREQ_COMP_TEMP_MAX) {
        oam_error_log3(0, OAM_SF_ANY,
            "{wal_customize_init_freq_comp::low_threshold[%d] out of range[%d,%d]!}\r\n",
    ...
    if (freq_comp_params.comp_val < FREQ_COMP_VAL_MIN || freq_comp_params.comp_val > FREQ_COMP_VAL_MAX) {
        oam_error_log3(0, OAM_SF_ANY,
            "{wal_customize_init_freq_comp::ppm_compesation[%d] out of range[%d,%d]!}\r\n",
...
hi_u32 wal_customize_set_config(hi_void)
{
    ...
    if (netdev == HI_NULL) {
        oam_error_log0(0, OAM_SF_ANY, "wifi_set_country Hisilicon0 device not fonud.");
        /* 释放从NVM读取的默认配置 */
...
hi_u32 wal_sync_boot_current_to_dev(const hi_char* ifname)
{
    ...
    if (netdev == HI_NULL) {
        oam_error_log0(0, 0, "wal_minimize_boot_current:: device not fonud.");
        return HI_FAIL;
    }
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    oal_dev_put(netdev);
