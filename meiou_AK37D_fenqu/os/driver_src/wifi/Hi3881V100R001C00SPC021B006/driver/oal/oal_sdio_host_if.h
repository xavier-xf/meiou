...
/* 用于非零拷贝时，输入、输出的buf*/
#define _PRE_SDIO_FEATURE_FLAT_MEMORY
#ifdef _PRE_SDIO_FEATURE_FLAT_MEMORY
#define SDIO_MAX_FLAT_MEMORY_SIZE   (1024 * 128)
#endif
...
#ifdef _PRE_SDIO_FEATURE_FLAT_MEMORY
    hi_void                *tx_flat_buff;   /* use the mem when tx */
    hi_u32                  tx_flat_buff_len;
    hi_void                *rx_flat_buff;   /* use the mem when rx */
    hi_u32                  rx_flat_buff_len;
#endif
