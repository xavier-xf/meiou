...
#ifdef _PRE_LOSCFG_KERNEL_SMP
#ifndef G_TASK_SMP_SPIN_LOCK
#define G_TASK_SMP_SPIN_LOCK
static SPIN_LOCK_INIT(g_task_smp_spinlock);
#endif
#endif
...
{
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinLock(&g_task_smp_spinlock);
#else
    LOS_TaskLock();
#endif
}
...
{
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinUnlock(&g_task_smp_spinlock);
#else
    LOS_TaskUnlock();
#endif
}
