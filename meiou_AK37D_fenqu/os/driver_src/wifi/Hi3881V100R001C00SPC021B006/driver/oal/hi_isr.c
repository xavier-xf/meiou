...
#ifdef _PRE_LOSCFG_KERNEL_SMP
#ifndef G_IRS_SMP_SPIN_LOCK
#define G_IRS_SMP_SPIN_LOCK
static SPIN_LOCK_INIT(g_irs_smp_spinlock);
#endif
#endif
...
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinLockSave(&g_irs_smp_spinlock, &int_value);
#else
...
#ifdef _PRE_LOSCFG_KERNEL_SMP
    LOS_SpinUnlockRestore(&g_irs_smp_spinlock, int_save);
#else
