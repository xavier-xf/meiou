...
{
    sample_at_log_print("sle uart server send by handle\r\n");
    ...
    sample_at_log_print("sle uart server send by handle g_server_id 0x%x g_sle_conn_hdl 0x%x\r\n",
