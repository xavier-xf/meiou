...
struct mac_rx_ctl {
    ...
    osal_u16                  _wGROzPmwOmPIOzoR3_ : 12; /* evm */
...
typedef union {
    ...
    struct {
        osal_u32 __uLwW__wuG_Gw6NgwW___ : 1;              /* [0]  */
        osal_u32 __uLwW__wLPwqW6Li_wW___ : 1;             /* [1]  */
        osal_u32 __uLwW__wjGwWhL_twhiLwNidhF_ : 1;        /* [2]  */
        osal_u32 __uLwW__wuQtwL_o_wLBSWwidL_ : 1;         /* [3]  */
        osal_u32 __uLwW__wuQtw_PwNBNiwiqW__dh_ : 1;       /* [4]  */
        osal_u32 __uLwW__wLPwFGLGNoiTwj_WGK_ : 1;         /* [5]  */
        osal_u32 _wGROmwwOw8OtsIOsRORlImvSR_ : 1;         /* [6]  */
        osal_u32 _wGROmwwOR8OtsIOsRORlImvSR_ : 1;         /* [7]  */
        osal_u32 _wGROmwwOw8OAzo4xmwOsRORlImvSR_ : 1;     /* [8]  */
        osal_u32 _wGROmwwOR8OAzo4xmwOsRORlImvSR_ : 1;     /* [9]  */
        osal_u32 _wGROmwwOR8OloRwOtltvOvPmwwSo_ : 1;      /* [10]  */
        osal_u32 _wGROmwwOw8OloRwOtltvOvPmwwSo_ : 1;      /* [11]  */
        osal_u32 _wGROmwwOAlw8OloRwOtltvOvPmwwSo_ : 1;    /* [12]  */
        osal_u32 __uLwW__wdhWPuW6LWFw_PwRwWSuLt_ : 1;     /* [13]  */
        osal_u32 __uLwW__wdhWPuW6LWFwQB_PwRwWSuLt_ : 1;   /* [14]  */
        osal_u32 __uLwW__wjdCw_oWhwW___ : 1;              /* [15]  */
        osal_u32 _wGROmwwOySsOwz44wOmww_ : 1;             /* [16]  */
        osal_u32 __uLwW__wjdCwToWhwW___ : 1;              /* [17]  */
        osal_u32 _wGROmwwOySsOqz44wOmww_ : 1;             /* [18]  */
        osal_u32 _wGROmwwOR8OzCydO6OvPmwwSo_ : 1;         /* [19]  */
        osal_u32 __uLwW__wLPwG6jWwRwiqW__dh_ : 1;         /* [20]  */
        osal_u32 _wGROmwwOR8OzCPlO6OvPmwwSo_ : 1;         /* [21]  */
        osal_u32 _wGROmwwOR8OzCPvO6OvPmwwSo_ : 1;         /* [22]  */
        osal_u32 _wGROmwwOR8OAlGwlO6OvPmwwSo_ : 1;        /* [23]  */
        osal_u32 _wGROmwwOIzRwl8OCzxCORlImOvSR_ : 1;      /* [24]  */
        osal_u32 _wGROmwwOCCzORlImOvSR_ : 1;              /* [25]  */
        osal_u32 _wGRORyOloRwOmww_ : 1;                   /* [26]  */
        osal_u32 _wGROmwwOymzCvoOIlss_ : 1;               /* [27]  */
        osal_u32 __uLwW__wBhL_wNBNiwdhWPuW6LWFw_WGF_ : 1; /* [28]  */
        osal_u32 _wGROmwwOSom8GmCRm4Ow8O4msCOz44w_ : 1;   /* [29]  */
        osal_u32 _wGROmwwOw8OvPmwxzGOmww_ : 1;            /* [30]  */
...
typedef union {
    /* Define the struct  bits */
    struct {
        osal_u32 _wGROmwwOR8OzCymOyzCdvttORlImvSR_ : 1;  /* [0]  */
        osal_u32 __uLwW__wLPwG6jKwjG6KiNNwLBSWidL_ : 1;  /* [1]  */
        osal_u32 __uLwW__wLPwG6qBwjG6KiNNwLBSWidL_ : 1;  /* [2]  */
        osal_u32 __uLwW__wLPwG6qiwjG6KiNNwLBSWidL_ : 1;  /* [3]  */
        osal_u32 __uLwW__wLPwQBu_BwjG6KiNNwLBSWidL_ : 1; /* [4]  */
        osal_u32 __uLwW__w_PwCSGoowRwWSuLt_ : 1;         /* [5]  */
        osal_u32 _wGROmwwOGzwzOCt2OZmww_ : 1;            /* [6]  */
        osal_u32 _wGROmwwOGzwzOCt2Oimww_ : 1;            /* [7]  */
        osal_u32 __uLwW__wWF6GwCLwLBSWidL_ : 1;          /* [8]  */
        osal_u32 __uLwW__wuG_Gw6NgwDW___ : 1;            /* [9]  */
        osal_u32 _wGROmwwOR8OyCO6OvPmwwSo_ : 1;          /* [10]  */
        osal_u32 _wGROmwwOyssOozPOGwvR_ : 1;             /* [11]  */
        osal_u32 _wGROmwwOvyssOozPOGwvR_ : 1;            /* [12]  */
        osal_u32 _wGROmwwOySsOwqORlImvSR_ : 1;           /* [13]  */
        osal_u32 __uLwLPwFGLGwNBNiwiqW__dh_ : 1;         /* [14]  */
        osal_u32 __uLw_PwFGLGwNBNiwiqW__dh_ : 1;         /* [15]  */
        osal_u32 __uLwLPjNwNBNiwiqW__dh_ : 1;            /* [16]  */
