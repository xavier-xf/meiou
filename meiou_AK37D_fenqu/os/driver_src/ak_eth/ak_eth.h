...
#define TRANSMIT_DESC_SIZE  256	// 32 Tx Descriptors needed in the Descriptor pool/queue
#define RECEIVE_DESC_SIZE   256	// 32 Rx Descriptors needed in the Descriptor pool/queue
...
typedef struct synopGMACDeviceStruct
{
    ...
    s32  RxNext;                   /* index of the rx descriptor next available with driver, given to DMA by gmac_set_rx_qptr() */
