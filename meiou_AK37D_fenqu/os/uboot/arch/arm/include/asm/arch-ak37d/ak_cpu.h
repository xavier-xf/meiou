...
#define SHARE_PIN_CFG2_REG				(CHIP_CONF_BASE_ADDR + 0x00000180)     // SHARE PIN CFG3
#define SHARE_PIN_CFG3_REG				(CHIP_CONF_BASE_ADDR + 0x00000184)     // SHARE PIN CFG4
#define SHARE_PIN_CFG4_REG				(CHIP_CONF_BASE_ADDR + 0x00000188)     // SHARE PIN CFG5
#define SHARE_PIN_CFG5_REG				(CHIP_CONF_BASE_ADDR + 0x0000018C)     // SHARE PIN CFG6
#define SHARE_PIN_CFG6_REG				(CHIP_CONF_BASE_ADDR + 0x00000190)     // SHARE PIN CFG7

#define PU_PD_ENABLE_CFG0_REG			(CHIP_CONF_BASE_ADDR + 0x00000194)
#define PU_PD_ENABLE_CFG1_REG			(CHIP_CONF_BASE_ADDR + 0x00000198)
#define PU_PD_ENABLE_CFG2_REG			(CHIP_CONF_BASE_ADDR + 0x0000019c)
