...
#define SHARE_PIN_CFG0_REG				(CHIP_CONF_BASE_ADDR + 0x00000074)//0x00000178)     // SHARE PIN CFG1
#define SHARE_PIN_CFG1_REG				(CHIP_CONF_BASE_ADDR + 0x00000078)//0x0000017C)     // SHARE PIN CFG2
#define SHARE_PIN_CFG2_REG				(CHIP_CONF_BASE_ADDR + 0x0000007C)//0x00000180)     // SHARE PIN CFG3
#define SHARE_PIN_CFG3_REG				(CHIP_CONF_BASE_ADDR + 0x000000DC)//0x00000184)     // SHARE PIN CFG4


#define SHARE_PIN_CFG4_REG				(CHIP_CONF_BASE_ADDR + 0x00000014)//0x00000188)     // SHARE PIN CFG5
#define SHARE_PIN_CFG5_REG				(CHIP_CONF_BASE_ADDR + 0x000000A4)//0x0000018C)     // SHARE PIN CFG6
...
#define SD_MMC_BASE_ADDR                                0x0 //SD1_BASE_ADDR       /*mmc_sd interface*/
...
#define TIMER9_CTRL1_REG       	                    (TIMER_MODULE_BASE_ADDR + 0x10C)
#define TIMER9_CTRL2_REG       	                    (TIMER_MODULE_BASE_ADDR + 0x110)
