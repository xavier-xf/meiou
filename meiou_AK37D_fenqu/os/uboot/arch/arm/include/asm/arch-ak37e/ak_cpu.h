...
#define CLOCK_CTRL2_REG                                 (CHIP_CONF_BASE_ADDR + 0x000000FC)      // module clock control(switch)
...
#define IRQINT_MASK_REG                                 (CHIP_CONF_BASE_ADDR + 0x00000024)      // cdh:module IRQ interrupt mask register, 1: mask; 0:unmask(default);
#define FRQINT_MASK_REG                                 (CHIP_CONF_BASE_ADDR + 0x00000028)      // cdh:module FRQ interrupt mask register, 1: mask; 0:unmask(default);
#define INT_STATUS_REG                                  (CHIP_CONF_BASE_ADDR + 0x0000004C)      // cdh:module interrupt status register
#define INT_SYS_MODULE_REG                              (CHIP_CONF_BASE_ADDR + 0x00000030)      // cdh:system module interrupt status control register
...
#define SHARE_PIN_CFG0_REG				(CHIP_CONF_BASE_ADDR + 0x0000015C)     // SHARE PIN CFG0
#define SHARE_PIN_CFG1_REG				(CHIP_CONF_BASE_ADDR + 0x00000160)     // SHARE PIN CFG1
#define SHARE_PIN_CFG2_REG				(CHIP_CONF_BASE_ADDR + 0x00000164)     // SHARE PIN CFG2
#define SHARE_PIN_CFG3_REG				(CHIP_CONF_BASE_ADDR + 0x00000168)     // SHARE PIN CFG3
#define SHARE_PIN_CFG4_REG				(CHIP_CONF_BASE_ADDR + 0x0000016C)     // SHARE PIN CFG4
#define SHARE_PIN_CFG5_REG				(CHIP_CONF_BASE_ADDR + 0x00000170)     // SHARE PIN CFG5
#define SHARE_PIN_CFG6_REG				(CHIP_CONF_BASE_ADDR + 0x00000174)     // SHARE PIN CFG6
#define SHARE_PIN_CFG7_REG				(CHIP_CONF_BASE_ADDR + 0x00000178)     // SHARE PIN CFG7
#define SHARE_PIN_CFG8_REG				(CHIP_CONF_BASE_ADDR + 0x0000017C)     // SHARE PIN CFG8
#define SHARE_PIN_CFG9_REG				(CHIP_CONF_BASE_ADDR + 0x00000180)     // SHARE PIN CFG9


#define PU_PD_ENABLE_CFG0_REG			(CHIP_CONF_BASE_ADDR + 0x000001D0)
#define PU_PD_ENABLE_CFG1_REG			(CHIP_CONF_BASE_ADDR + 0x000001D4)
#define PU_PD_ENABLE_CFG2_REG			(CHIP_CONF_BASE_ADDR + 0x000001D8)
//#define PU_PD_ENABLE_CFG3_REG			(CHIP_CONF_BASE_ADDR + 0x000001F8)

#define PU_PD_SEL_CFG0_REG				(CHIP_CONF_BASE_ADDR + 0x000001E4)
#define PU_PD_SEL_CFG1_REG				(CHIP_CONF_BASE_ADDR + 0x000001E8)
#define PU_PD_SEL_CFG2_REG				(CHIP_CONF_BASE_ADDR + 0x000001EC)
//#define PU_PD_SEL_CFG3_REG				(CHIP_CONF_BASE_ADDR + 0x000001F8)


#define PAD_DRV_CFG0_REG				(CHIP_CONF_BASE_ADDR + 0x0000018C)
#define PAD_DRV_CFG1_REG				(CHIP_CONF_BASE_ADDR + 0x00000190)
#define PAD_DRV_CFG2_REG				(CHIP_CONF_BASE_ADDR + 0x00000194)
#define PAD_DRV_CFG3_REG				(CHIP_CONF_BASE_ADDR + 0x00000198)
#define PAD_DRV_CFG4_REG				(CHIP_CONF_BASE_ADDR + 0x0000019C)
#define PAD_DRV_CFG5_REG				(CHIP_CONF_BASE_ADDR + 0x000001A0)
//#define PAD_DRV_CFG6_REG				(CHIP_CONF_BASE_ADDR + 0x000001F8)


#define PAD_IE_CFG0_REG					(CHIP_CONF_BASE_ADDR + 0x00000234)
#define PAD_IE_CFG1_REG					(CHIP_CONF_BASE_ADDR + 0x00000238)
#define PAD_IE_CFG2_REG					(CHIP_CONF_BASE_ADDR + 0x0000023C)
//#define PAD_IE_CFG3_REG					(CHIP_CONF_BASE_ADDR + 0x000001F8)

#define PAD_SL_CFG0_REG                 (CHIP_CONF_BASE_ADDR + 0x00000220)
#define PAD_SL_CFG1_REG                 (CHIP_CONF_BASE_ADDR + 0x00000224)
#define PAD_SL_CFG2_REG                 (CHIP_CONF_BASE_ADDR + 0x00000228)
 ...
 */
#define SD1_BASE_ADDR                                	0x20100000       	/*sd1 interface*/
#define SD2_BASE_ADDR                                  	0x20108000       	/*sd2 interface*/
#define SD3_BASE_ADDR                                  	0x201B0000       	/*sd3 interface*/
#define SD_MMC_BASE_ADDR                                0x0//SD3_BASE_ADDR       /*mmc_sd interface*/
//#define SDIO_BASE_ADDR                                  SD2_BASE_ADDR       /*sdio interface*/
...
#define SD_PLUG_IN_OFF_REG                              ( 0x08000080 )
...
#define TIMER1_CTRL1_REG                                 (TIMER_MODULE_BASE_ADDR + 0xb4)
#define TIMER2_CTRL1_REG                                 (TIMER_MODULE_BASE_ADDR + 0xbc)
#define TIMER3_CTRL1_REG                                 (TIMER_MODULE_BASE_ADDR + 0xc4)
#define TIMER4_CTRL1_REG                                 (TIMER_MODULE_BASE_ADDR + 0xcc)
#define TIMER5_CTRL1_REG                                 (TIMER_MODULE_BASE_ADDR + 0xd4) 

#define TIMER1_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0xb8)
#define TIMER2_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0xc0)
#define TIMER3_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0xc8)
#define TIMER4_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0xd0)
#define TIMER5_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0xd8)
#define TIMER6_CTRL1_REG                            (TIMER_MODULE_BASE_ADDR + 0x1C0)
#define TIMER6_CTRL2_REG                            (TIMER_MODULE_BASE_ADDR + 0x1C4)

#define TIMER9_CTRL1_REG       	                    (TIMER_MODULE_BASE_ADDR + 0x0208)
#define TIMER9_CTRL2_REG                        	(TIMER_MODULE_BASE_ADDR + 0x020C)


/** @} */

/** @{@name Watch_dog TIMER module register and bit map define
 */
...
#define GPIO_DIR_REG4                                   (GPIO_MODULE_BASE_ADDR + 0x0c)
...
* cdh:check ok
*/                                  
#define GPIO_OUT_REG1                                   (GPIO_MODULE_BASE_ADDR + 0x14)
#define GPIO_OUT_REG2                                   (GPIO_MODULE_BASE_ADDR + 0x18)
#define GPIO_OUT_REG3                                   (GPIO_MODULE_BASE_ADDR + 0x1c)
#define GPIO_OUT_REG4                                   (GPIO_MODULE_BASE_ADDR + 0x20)
...
* cdh:check ok
*/                                   
#define GPIO_IN_REG1                                    (GPIO_MODULE_BASE_ADDR + 0x28)
#define GPIO_IN_REG2                                    (GPIO_MODULE_BASE_ADDR + 0x2c)
#define GPIO_IN_REG3                                    (GPIO_MODULE_BASE_ADDR + 0x30)
#define GPIO_IN_REG4                                    (GPIO_MODULE_BASE_ADDR + 0x34)
...
* cdh:check ok
*/                       
#define GPIO_INT_EN1                                    (GPIO_MODULE_BASE_ADDR + 0x3c)
#define GPIO_INT_EN2                                    (GPIO_MODULE_BASE_ADDR + 0x40)
#define GPIO_INT_EN3                                    (GPIO_MODULE_BASE_ADDR + 0x44)
#define GPIO_INT_EN4                                    (GPIO_MODULE_BASE_ADDR + 0x48)
...
* cdh:check ok
*/                  
#define GPIO_INT_LEVEL_REG1                             (GPIO_MODULE_BASE_ADDR + 0x64)
#define GPIO_INT_LEVEL_REG2                             (GPIO_MODULE_BASE_ADDR + 0x68)
#define GPIO_INT_LEVEL_REG3                             (GPIO_MODULE_BASE_ADDR + 0x6c)
#define GPIO_INT_LEVEL_REG4                             (GPIO_MODULE_BASE_ADDR + 0x70)
                                                        
/*
* gpio pull/pulldown sel and enable reg   
* cdh:check ok
*/                             
#define GPIO_PULLUPDOWN_REG1                            (GPIO_MODULE_BASE_ADDR + 0x1A0)
#define GPIO_PULLUPDOWN_REG2                            (GPIO_MODULE_BASE_ADDR + 0x1A4)
#define GPIO_PULLUPDOWN_REG3                            (GPIO_MODULE_BASE_ADDR + 0x1E8)
#define GPIO_PULLUPDOWN_REG4                            (GPIO_MODULE_BASE_ADDR + 0x1F8)

#define GPIO_ENABLE_PULLUPDOWN_REG1                     (GPIO_MODULE_BASE_ADDR + 0x194)
#define GPIO_ENABLE_PULLUPDOWN_REG2                     (GPIO_MODULE_BASE_ADDR + 0x198)
#define GPIO_ENABLE_PULLUPDOWN_REG3                     (GPIO_MODULE_BASE_ADDR + 0x19C)
#define GPIO_ENABLE_PULLUPDOWN_REG4                     (GPIO_MODULE_BASE_ADDR + 0x1F8)
...
* cdh:check ok
*/                                
#define GPIO_SHAREPIN_CONTROL1                          (CHIP_CONF_BASE_ADDR + 0x178)
#define GPIO_SHAREPIN_CONTROL2                          (CHIP_CONF_BASE_ADDR + 0x17c)
#define GPIO_SHAREPIN_CONTROL3                          (CHIP_CONF_BASE_ADDR + 0x180)
#define GPIO_SHAREPIN_CONTROL4                          (CHIP_CONF_BASE_ADDR + 0x184)
#define GPIO_SHAREPIN_CONTROL5                          (CHIP_CONF_BASE_ADDR + 0x188)
#define GPIO_SHAREPIN_CONTROL6                          (CHIP_CONF_BASE_ADDR + 0x18c)
#define GPIO_SHAREPIN_CONTROL7                          (CHIP_CONF_BASE_ADDR + 0x190)
