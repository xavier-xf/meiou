...
static int ak_mmc_sd_sharepin_cfg(int mmcdev_index)
{
	...
	gpio_set_pin_as_gpio(g_power_on_pin);
	gpio_direction_output(g_power_on_pin, 1);
	gpio_set_pin_level(g_power_on_pin, 0);
...
static int ak_mmc_sd_sharepin_cfg(int mmcdev_index)
{
	...
	if (mmcdev_index == 2)
	{
		//<XGPIO_091 XGPIO_092 XGPIO_093 XGPIO_094 XGPIO_095 XGPIO_096>  ޷                  XGPIO_094 Ϊ    ֮ ⣬     Ϊ    
		printf("leo : sd_choose_mmc2\n");
		// pupd disable
		value = REG32(PU_PD_ENABLE_CFG0_REG);
		value &= ~((1 << 12) | (1 << 13) | (1 << 14) | (1 << 15) | (1 << 16) | (1 << 17));
		value |= ((1 << 12) | (1 << 13) | (1 << 14) | (1 << 15) | (1 << 16) | (1 << 17));
		REG32(PU_PD_ENABLE_CFG0_REG) = value;
		...
		gpio_set_pin_as_gpio(19);
		gpio_set_pin_as_gpio(20);
		gpio_set_pin_as_gpio(23);
		gpio_set_pin_as_gpio(24);
	...
	{ // cdh:sd3
		printf("leo:sd3 share pin!\n");
#if 1
		value = REG32(SHARE_PIN_CFG0_REG);
		value &= ~((0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		value |= ((0x2 << 24) | (0x2 << 26) | (0x2 << 28) | (0x2 << 30));
		REG32(SHARE_PIN_CFG0_REG) = value;
		...
		value = REG32(SHARE_PIN_CFG6_REG);
		value &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x01 << 6));
		value |= ((0x1 << 0) | (0x1 << 2) | (0x00 << 4) | (0x00 << 6));
		REG32(SHARE_PIN_CFG6_REG) = value;
		...
		value = REG32(PAD_DRV_CFG0_REG);
		value &= ~((3 << 24) | (3 << 26) | (3 << 28) | (3 << 30));
		value |= ((3 << 24) | (3 << 26) | (3 << 28) | (3 << 30));
		REG32(PAD_DRV_CFG0_REG) = value;

		value = REG32(PAD_DRV_CFG1_REG);
		value &= ~((1 << 0) | (1 << 2));
		value |= ((3 << 0) | (3 << 2));
		REG32(PAD_DRV_CFG1_REG) = value;
#else
		// todo
		value = REG32(SHARE_PIN_CFG5_REG);
