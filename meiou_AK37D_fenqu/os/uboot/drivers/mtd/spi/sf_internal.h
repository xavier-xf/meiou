...
#define CMD_XMC_WRITE_STATUS3   0xc0
...
#define CMD_XMC_READ_STATUS2    0x09    /* Read XMC Status Register2 */ 
#define CMD_XMC_READ_STATUS3  	0x95    /* Read XMC Status Register3 */ 
...
#define CMD_ADDR_4BYTE_MODE 	0xB7	/*Enter 4-Byte Address Mode*/
...
int spi_flash_cmd_id(struct spi_slave *spi, u8 *cmd, u32 cmd_len, void *response, size_t len);
