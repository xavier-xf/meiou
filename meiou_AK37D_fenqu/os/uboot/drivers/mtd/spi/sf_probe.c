...
static 	struct flash_status_reg status_reg_list[] = {
		...
		/*spiflash xm25qh64a*/
		{
			...
			.b_wip = 0, .b_wel = 1, .b_bp0 = 2, .b_bp1 = 3,
			.b_bp2 = 4, .b_bp3 = 5, .b_qe = 6,	.b_srp0 = 7,
			.read_sr = spi_flash_xmc_cmd_read_status,
			.write_sr = spi_flash_xmc_cmd_write_status,
		},
		...
		/* WB w25q32 4MB flash */ 
		{
			...
			.b_sus = 15, 
			.read_sr = spi_flash_cmd_read_status,
			.write_sr = spi_flash_winbond_cmd_write_status_volatile,
		},
		/* w25q64jv 8MB flash */
		{
			.jedec_id = 0xef4017,	.ext_id = 0,
			.b_wip = 0,	.b_wel = 1,	.b_bp0 = 2,	.b_bp1 = 3,
			.b_bp2 = 4,	.b_bp3 = 5,	.b_bp4 = 6,	.b_srp0 = 7,
			.b_srp1 = 8, .b_qe = 9,	.b_lb = 11,	.b_cmp = 14,
			.b_sus = 15, 
...
static const struct spi_flash_params spi_flash_params_table[] = {
	...
	{ "w25q64fv", 0xef4017, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS3|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},
	...
	{ "w25q128", 0xef4018, 0, 64 * 1024, 256,  SECT_4K|SFLAG_COM_STATUS3|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE, 0,},
	...
	{ "xm25qh64c", 0x204017, 0, 64 * 1024, 128, SECT_4K|SFLAG_COM_STATUS2|SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE|SFLAG_QUAD_NO_QE , 0,},
