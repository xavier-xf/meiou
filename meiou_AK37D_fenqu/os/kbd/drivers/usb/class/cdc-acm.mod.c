...
MODULE_ALIAS("usb:v2C7Cp6026d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1286p4E3Dd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1782p4E00d*dc*dsc*dp*ic*isc*ip*in*");
