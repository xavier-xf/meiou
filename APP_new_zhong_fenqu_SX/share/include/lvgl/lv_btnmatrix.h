 ...
 *      DEFINES
 *********************/
#define LV_BTNMATRIX_WIDTH_MASK 0x00F
...
enum {
    LV_BTNMATRIX_CTRL_HIDDEN     = 0x0010,//0x0008, /**< Button hidden */
    LV_BTNMATRIX_CTRL_NO_REPEAT  = 0x0020,//0x0010, /**< Do not repeat press this button. */
    LV_BTNMATRIX_CTRL_DISABLED   = 0x0030,//0x0020/**< Disable this button. */
...
typedef struct {
    ...
    lv_btnmatrix_ctrl_t * lines_offset_x;              /*用于行偏移*/
	...
	lv_coord_t label_x_ofs;
	lv_coord_t label_y_ofs;

#ifdef LV_USE_PATTERN
    uint8_t pattern_same : 1;
