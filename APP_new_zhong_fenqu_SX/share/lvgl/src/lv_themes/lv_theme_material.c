...
#define COLOR_SCR LV_COLOR_BLACK //(IS_LIGHT ? lv_color_hex(0xeaeff3) :  LV_COLOR_BLACK /*lv_color_hex(0x444b5a)*/)
...
static void page_init(void)
{
	...
	lv_style_set_bg_opa(&styles->sb, LV_STATE_DEFAULT, LV_OPA_TRANSP);
	...
	lv_style_set_bg_opa(&styles->edge_flash, LV_STATE_DEFAULT, LV_OPA_TRANSP);
